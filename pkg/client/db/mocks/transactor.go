...
//go:generate minimock -i github.com/passsquale/platform_common/pkg/client/db.Transactor -o transactor.go -n TransactorMock -p mocks
...
type TransactorMock struct {
	...
	funcBeginTx          func(ctx context.Context, txOptions pgx.TxOptions) (t1 mm_db.Tx, err error)
...
func (mmBeginTx *mTransactorMockBeginTx) Return(t1 mm_db.Tx, err error) *TransactorMock {
	if mmBeginTx.mock.funcBeginTx != nil {
		mmBeginTx.mock.t.Fatalf("TransactorMock.BeginTx mock is already set by Set")
	}
...
func (mmBeginTx *mTransactorMockBeginTx) Set(f func(ctx context.Context, txOptions pgx.TxOptions) (t1 mm_db.Tx, err error)) *TransactorMock {
	if mmBeginTx.defaultExpectation != nil {
...
func (e *TransactorMockBeginTxExpectation) Then(t1 mm_db.Tx, err error) *TransactorMock {
	e.results = &TransactorMockBeginTxResults{t1, err}
	return e.mock
}

// BeginTx implements db.Transactor
func (mmBeginTx *TransactorMock) BeginTx(ctx context.Context, txOptions pgx.TxOptions) (t1 mm_db.Tx, err error) {
