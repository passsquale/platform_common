...
//go:generate minimock -i github.com/passsquale/platform_common/pkg/client/db.DB -o db.go -n DBMock -p mocks
...
func (mmBeginTx *mDBMockBeginTx) Return(t1 mm_db.Tx, err error) *DBMock {
	if mmBeginTx.mock.funcBeginTx != nil {
		mmBeginTx.mock.t.Fatalf("DBMock.BeginTx mock is already set by Set")
	}
...
func (mmBeginTx *mDBMockBeginTx) Set(f func(ctx context.Context, txOptions pgx.TxOptions) (t1 mm_db.Tx, err error)) *DBMock {
	if mmBeginTx.defaultExpectation != nil {
...
func (e *DBMockBeginTxExpectation) Then(t1 mm_db.Tx, err error) *DBMock {
	e.results = &DBMockBeginTxResults{t1, err}
	return e.mock
}

// BeginTx implements db.DB
func (mmBeginTx *DBMock) BeginTx(ctx context.Context, txOptions pgx.TxOptions) (t1 mm_db.Tx, err error) {
